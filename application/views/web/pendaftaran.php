...
<head>
  ...
  <title>PPDB MIN 3 WAY KANAN TEGAL MUKTI</title>
            ...
            <div style="margin-top:-8px;">
              <h2>
                <strong class="text-primary">
                  <a href=""><img src="img/logo_min.png" alt="Logo" width="38" style="position:absolute;margin-top:-8px;"> <span style="margin-left:50px;color:#fff;">PPDB Online</span></a>
                </strong>
                </h>
            </div>
          </div>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Form Pendaftaran PPDB Online <strong> MIN 3 WAY KANAN TEGAL MUKTI</strong></h2>
            ...
            <?= form_error('nisn', '<large class="text-danger pl-3">', '</large>'); ?></h3></b>
                  ...
                  <div class="tab-pane active" id="style">
                    ...
                    <div class="wizard-div current wizard-sea" id="register">
                      <form role="form" class="wizard wizard-validation" data-style="sea" role="form" action="" enctype="multipart/form-data" method="post">
                        ...
                        <fieldset>
                          <legend>Jalur Pendaftaran</legend>
                          <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-md-8">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 panel p-20" style="text-align:center">
                                ...
                                <span style="font-size:15px">
                                  Proses PPDB Online MIN 3 WAY KANAN TEGAL MUKTI hampir selesai. Silakan periksa kembali data-data calon siswa yang sudah anda masukkan.
                                  <br><br>
                                  <div class="col-md-12">
            ...
            <div class="footer">
              <div class="copyright">
                <p class="pull-left sm-pull-reset">
                  <span> Copyright &copy; <?php echo date('Y'); ?> Sistem Informasi PPDB MIN 3 WAY KANAN TEGAL MUKTI</span>
                </p>
