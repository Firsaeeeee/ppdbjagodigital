    ...
    <div class="table-responsive">
      <table class="table table-bordered table-striped" width="100%" border="1">
        ...
        <tr>
          ...
          <?php for ($i = 1; $i <= 5; $i++) { ?>
            <td>
              <input type="text" name="ips<?php echo $i; ?>" value="" onkeyup="hitung('ips');" id="tbl_input" maxlength="6" data-parsley-group="block5" data-parsley-errors-container='div[id="error-ing<?php echo $i; ?>"]' required>
...
<div class="col-md-12">
  ...
  <blockquote>
    <p><b>CATATAN:</b> <span class="text-danger ">Harap Nilai Raport Diisi Semua Dengan Yang Sesuai Di Raport ! </span><b class="text-danger"></b><br>
      <b>Keterangan:</b> <span class="text-danger ">K : Kelas | SMT : Semester </span><b class="text-danger"></b>
    </p>
  ...
  <div>
    ...
    <script type="text/javascript">
      ...
      function hitung(name) {
        ...
        jml_nilai = parseInt($('#nilai_ipa').text()) + parseInt($('#nilai_mtk').text()) + parseInt($('#nilai_ind').text()) + parseInt($('#nilai_ing').text()) + parseInt($('#nilai_ips').text());
