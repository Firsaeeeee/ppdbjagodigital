<div class="panel panel-primary">
  ...
  <div class="panel-body">
    ...
    <div class="form-group">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">NPSN Sekolah Asal <span class="text-danger">*</span></label>
      <div class="col-sm-9" style="margin-top:3px;">
        <input type="text" name="npsn_sekolah" class="form-control bg-blue" placeholder="NPSN Sekolah Asal" maxlength="100" data-parsley-group="block3" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-npsn_sekolah"]' required>
