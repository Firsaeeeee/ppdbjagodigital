...
<body>
  ...
  <table width="100%" border="1">
    <tr>
      <th rowspan="4">No.</th>
      <th rowspan="3" colspan="22">BIODATA SISWA</th>
    ...
    foreach ($v_siswa->result() as $baris) :
      ...
      $ips = $this->db->get_where('tbl_rapor', array('no_pendaftaran' => $baris->no_pendaftaran, "mapel"=>"Ilmu Pengetahuan Sosial (IPS)"))->row();
      $rata_rata_rapor = number_format(($ipa->rata_rata_nilai + $mtk->rata_rata_nilai + $ind->rata_rata_nilai + $ing->rata_rata_nilai + $ips->rata_rata_nilai) / 5, 2, ",", ".");
    ...
    ?>
      <tr>
        ...
        <td><?php echo ucwords($baris->jalur_pendaftaran); ?></td>
