        ...
        <table class="table datatable-basic table-bordered" width="100%">
          ...
          <tbody>
              ...
              <!--    <td><?php echo $baris->nis; ?></td> -->
                  ...
                  <td><?php echo $baris->jalur_pendaftaran; ?></td>
                  ...
                  <td align="center">
                  <a href="panel_admin/verifikasi_cetak/<?php echo $baris->no_pendaftaran; ?>" class="btn btn-default btn-xs" title="Lihat Data" target="_blank"><i class="icon-eye"></i></a>
