...
<head>
	...
	<?php
	if ($sub_menu == "verifikasi" or $sub_menu == "set_pengumuman" or $sub_menu == "manajemen_user") { ?>
		<!-- Theme JS files -->
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="assets/images/user.jpg" alt="foto">
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="panel_admin/profile" class="media-left"><img src="img/logo_min.png" class="img-circle img-sm" alt="foto"></a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if ($menu == 'panel_admin' and $sub_menu == 'manajemen_user' or $sub_menu == 'edit_materi') {
												echo 'active';
											} ?>"><a href="panel_admin/manajemen_user"><i class="icon-user"></i> <span>Manajemen User</span></a></li>
								...
								<li class="<?php if ($menu == 'panel_admin' and $sub_menu == 'export') {
												echo 'active';
											} ?>"><a href="panel_admin/export"><i class="icon-file-excel"></i> <span>Export Data Calon Siswa</span></a></li>
