...
<body class="navbar-bottom <?php if ($menu == 'panel_siswa' and $sub_menu == 'biodata') {
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="panel_siswa/biodata" class="media-left"><img src="assets/images/my_profile.png" height="150" class="img-circle img-sm" alt="foto"></a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if ($menu == 'panel_siswa' and $sub_menu == 'informasi') {
												echo 'active';
											} ?>"><a href="panel_siswa/informasi"><i class="icon-file-check"></i> <span>Informasi</span></a></li>
	...
	<li><a href="<?= base_url('files/Surat Pernyataan Keaslian Dokumen.doc'); ?> "><i class="glyphicon glyphicon-save"></i> <span>Unduh Surat Pernyataan Keaslian Dokumen</span></a></li>
